...
- Send notifications to Slack, Email, Telegram, Jira, Line Notify or an HTTP POST endpoint
...
* To set up Slack, Email, Jira, Line Notify, Mattermost or Telegram notifications, edit `rules/BaseRule.config`.
