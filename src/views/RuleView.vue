  ...
  <div v-if="loaded">
    <template v-if="name">
      ...
      <el-tabs type="card" class="m-n-sm">
        ...
        <el-tab-pane label="Alert log" name="alertlog">
        ...
        <el-tab-pane label="Query log" name="querylog">
        ...
        <el-tab-pane label="Silence log" name="silencelog">
          <el-alert
            show-icon
        ...
        <el-tab-pane v-if="yaml" label="ElastAlert 2 YAML" name="yaml">
