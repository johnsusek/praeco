<template>
  <div>
    ...
    <ESChart
      ...
      :agg-median="(metricAggType === 'median' && metricAggKey) || (metricAggType === 'spike aggregation' && spikeAggMetricAggType === 'median' && spikeAggMetricAggKey)"
      :agg-mode="(metricAggType === 'mode' && metricAggKey) || (metricAggType === 'spike aggregation' && spikeAggMetricAggType === 'mode' && spikeAggMetricAggKey)"
      :agg-percentiles="(metricAggType === 'percentiles' && metricAggKey) || (metricAggType === 'spike aggregation' && spikeAggMetricAggType === 'percentiles' && spikeAggMetricAggKey)"
      class="m-n-med"
      @click="clickChart"
