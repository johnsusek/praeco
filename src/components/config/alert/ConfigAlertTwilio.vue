<template>
  <div>
    <el-radio v-model="groupTwilio" :disabled="viewOnly" label="sms" border @change="changeTwilio">
      SMS
    </el-radio>
    <el-radio v-model="groupTwilio" :disabled="viewOnly" label="copilot" border @change="changeTwilio">
      Copilot
    </el-radio>

    <praeco-form-item label="Twilio Account Sid" prop="twilioAccountSid" required>
      <el-input v-model="twilioAccountSid" :disabled="viewOnly" />
      <label>This is sid of your twilio account.</label>
    </praeco-form-item>

    <praeco-form-item label="Twilio Auth Token" prop="twilioAuth" required>
      <el-input v-model="twilioAuth" :disabled="viewOnly" />
    ...
    <praeco-form-item label="Twilio To Number" prop="twilioToNumber" required>
      <el-input v-model="twilioToNumber" :disabled="viewOnly" />
    ...
    <div v-if="groupTwilio === 'sms'">
      <praeco-form-item label="Twilio From Number" prop="twilioFromNumber" required>
        <el-input v-model="twilioFromNumber" :disabled="viewOnly" />
    ...
    <div v-if="groupTwilio === 'copilot'">
      <praeco-form-item label="Twilio Message Service Sid" prop="twilioMessageServiceSid" required>
        <el-input v-model="twilioMessageServiceSid" :disabled="viewOnly" />
