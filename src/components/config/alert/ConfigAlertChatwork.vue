<template>
  <div>
    <praeco-form-item label="Api Key" prop="chatworkApikey" required>
      <el-input id="chatworkApikey" v-model="chatworkApikey" :disabled="viewOnly" @update:model-value="chatworkApikey = $event" />
      <label>ChatWork API KEY.</label>
    </praeco-form-item>

    <praeco-form-item label="Room Id" prop="chatworkRoomId" required>
      <el-input id="chatworkRoomId" v-model="chatworkRoomId" :disabled="viewOnly" @update:model-value="chatworkRoomId = $event" />
      <label>
    ...
    <praeco-form-item label="Proxy" prop="chatworkProxy">
      <el-input id="chatworkProxy" v-model="chatworkProxy" :disabled="viewOnly" @update:model-value="chatworkProxy = $event" />
      <label>
    ...
    <praeco-form-item label="Proxy Login" prop="chatworkProxyLogin">
      <el-input id="chatworkProxyLogin" v-model="chatworkProxyLogin" :disabled="viewOnly" @update:model-value="chatworkProxyLogin = $event" />
      <label>The chatwork proxy auth username.</label>
    </praeco-form-item>

    <praeco-form-item label="Proxy Password" prop="chatworkProxyPass">
      <el-input id="chatworkProxyPass" v-model="chatworkProxyPass" :disabled="viewOnly" @update:model-value="chatworkProxyPass = $event" />
