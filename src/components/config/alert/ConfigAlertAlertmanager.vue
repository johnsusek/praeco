<template>
  <div>
    ...
    <praeco-form-item label="alert_subject_labelname" prop="alertmanagerAlertSubjectLabelname">
      <el-input id="alertmanagerAlertSubjectLabelname" v-model="alertmanagerAlertSubjectLabelname" :disabled="viewOnly" @update:model-value="alertmanagerAlertSubjectLabelname = $event" />
      <label>
    ...
    <praeco-form-item label="alert_text_labelname" prop="alertmanagerAlertTextLabelname">
      <el-input id="alertmanagerAlertTextLabelname" v-model="alertmanagerAlertTextLabelname" :disabled="viewOnly" @update:model-value="alertmanagerAlertTextLabelname = $event" />
      <label>
    ...
    <praeco-form-item label="Timeout" prop="alertmanagerTimeout">
      <el-input-number id="alertmanagerTimeout" v-model="alertmanagerTimeout" :disabled="viewOnly" @update:model-value="alertmanagerTimeout = $event" />
      <label>
    ...
    <praeco-form-item label="Proxy" prop="alertmanagerProxy">
      <el-input id="alertmanagerProxy" v-model="alertmanagerProxy" :disabled="viewOnly" @update:model-value="alertmanagerProxy = $event" />
      <label>
    ...
    <praeco-form-item label="Proxy Login" prop="alertmanagerBasicAuthLogin">
      <el-input id="alertmanagerBasicAuthLogin" v-model="alertmanagerBasicAuthLogin" :disabled="viewOnly" @update:model-value="alertmanagerBasicAuthLogin = $event" />
    ...
    <praeco-form-item label="Proxy Password" prop="alertmanagerBasicAuthPassword">
      <el-input id="alertmanagerBasicAuthPassword" v-model="alertmanagerBasicAuthPassword" :disabled="viewOnly" @update:model-value="alertmanagerBasicAuthPassword = $event" />
