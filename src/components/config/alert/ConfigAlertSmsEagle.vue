<template>
  <div>
    <el-form-item label="smseagle_url" prop="smseagleUrl" required>
      <el-input id="smseagleUrl" v-model="smseagleUrl" :disabled="viewOnly" @update:model-value="smseagleUrl = $event" />
    </el-form-item>

    <el-form-item label="smseagle_token" prop="smseagleToken" required>
      <el-input id="smseagleToken" v-model="smseagleToken" :disabled="viewOnly" @update:model-value="smseagleToken = $event" />
    </el-form-item>
    ...
    <el-form-item label="smseagle_text" prop="smseagleText">
      <el-input id="smseagleText" v-model="smseagleText" :disabled="viewOnly" @update:model-value="smseagleText = $event" />
    </el-form-item>
            ...
            <el-row :gutter="5" justify="space-between">
              <el-col :span="20">
                <el-input
                  ...
                  @update:model-value="(val) => updateSmseagleTo(val, index)" />
              </el-col>
              <el-col :span="4">
                <el-button
                  :disabled="viewOnly"
            ...
            <el-row :gutter="5" justify="space-between">
              <el-col :span="20">
                <el-input-number
                  ...
                  @update:model-value="(val) => updateSmseagleContacts(val, index)" />
              </el-col>
              <el-col :span="4">
                <el-button
                  :disabled="viewOnly"
            ...
            <el-row :gutter="5" justify="space-between">
              <el-col :span="20">
                <el-input-number
                  ...
                  @update:model-value="(val) => updateSmseagleGroups(val, index)" />
              </el-col>
              <el-col :span="4">
                <el-button
                  :disabled="viewOnly"
    ...
    <el-form-item label="smseagle_duration" prop="smseagleDuration">
      <el-input-number id="smseagleDuration" v-model="smseagleDuration" :disabled="viewOnly" @update:model-value="smseagleDuration = $event" />
    </el-form-item>

    <el-form-item label="smseagle_voice_id" prop="smseagleVoiceId">
      <el-input-number id="smseagleVoiceId" v-model="smseagleVoiceId" :disabled="viewOnly" @update:model-value="smseagleVoiceId = $event" />
    </el-form-item>
  </div>
</template>
