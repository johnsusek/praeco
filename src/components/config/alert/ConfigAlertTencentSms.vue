<template>
  <div>
    ...
    <praeco-form-item label="Sdk Appid" prop="tencentSmsSdkAppid" required>
      <el-input v-model="tencentSmsSdkAppid" :disabled="viewOnly" />
    ...
    <praeco-form-item label="TemplateId" prop="tencentSmsTemplateId" required>
      <el-input v-model="tencentSmsTemplateId" :disabled="viewOnly" />
      <label>
        Template ID.
    ...
    <praeco-form-item label="Sign Name" prop="tencentSmsSignName">
      <el-input v-model="tencentSmsSignName" :disabled="viewOnly" />
      <label>
    ...
    <praeco-form-item label="Region" prop="tencentSmsRegion">
      <el-input v-model="tencentSmsRegion" :disabled="viewOnly" />
