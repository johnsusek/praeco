<template>
  <div>
    <praeco-form-item label="Integration URL" prop="pagertreeIntegrationUrl">
      <el-input id="pagertreeIntegrationUrl" v-model="pagertreeIntegrationUrl" :disabled="viewOnly" @update:model-value="pagertreeIntegrationUrl = $event" />
      <label>URL generated by PagerTree for the integration.</label>
    </praeco-form-item>

    <praeco-form-item label="Proxy" prop="pagertreeProxy" required>
      <el-input id="pagertreeProxy" v-model="pagertreeProxy" :disabled="viewOnly" @update:model-value="pagertreeProxy = $event" />
      <label>
